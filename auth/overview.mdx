...
<Tabs>
  <Tab title="Supabase">
    ...
    ```
      ...
      ## Auth Functions
    <AccordionGroup>
      <Accordion title="Sign In With Email/Password">
      ...
      <Accordion title="Sign Up With Email/Password">
